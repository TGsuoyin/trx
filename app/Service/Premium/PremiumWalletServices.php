...
class PremiumWalletServices
{
    ...
    */
    public function getList($type=0){
        $res = PremiumPlatform::select('rid','receive_wallet','status','get_tx_time')->where('status',0)->whereRaw('length(receive_wallet) = 34')->orderBy('rid')->get();
